...
const Table = () => {
    ...
    const fetchLeaves = async () => {
        try {
            const response = await axios.get('https://checksheet-api.vercel.app/api/leave', {
                headers: {
                ...
                <div className='p-6'>
                    ...
                    <div className='flex justify-between items-center'>
                        ...
                        <div className='space-x-3'>
                            ...
                            <button className='px-2 py-1 bg-teal-600 text-white hover:bg-teal-700' onClick={() => filterByButton("Approve")}>Approved</button>
